...
export ART_FOLDER=../../bridge/artifacts_presto
export VALIDATOR_SIGNATURES_DIR=../../bridge/validator_signatures_presto
export DB_RELAYER=../../bridge/hyperlane_db_relayer_presto_sepolia
export DB_VALIDATOR=../../bridge/hyperlane_db_validator_presto
